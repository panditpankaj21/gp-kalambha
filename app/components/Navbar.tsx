...
export default function Navbar() {
  ...
  const menuCategories = [
    {
      ...
      links: [
        ...
        { name: "पदाधिकारी व सदस्य", desc: "Elected Representatives", href: "#" },
        { name: "ग्रामपंचायत कर्मचारी", desc: "Staff Details", href: "#" },
        { name: "संपर्क", desc: "Office Location", href: "#" },
      ]
    },
    {
      title: "नागरिक सेवा",
      links: [
        { name: "शासकीय योजना", desc: "Govt Schemes", href: "#" },
        { name: "दाखले व प्रमाणपत्र", desc: "Certificates", href: "#" },
        { name: "आरोग्य व शिक्षण", desc: "Health & Education", href: "#" },
        { name: "पाणी पुरवठा", desc: "Water Supply", href: "#" },
      ]
    },
    {
      title: "विकास व वित्त",
  ...
  return (
    <nav className="bg-white  sticky top-0 z-50 shadow-md">
        ...
        <div className="flex justify-between items-center h-20 md:h-24">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <p className="text-slate-500 text-[10px] md:text-xs uppercase font-bold tracking-tighter mt-1 italic">
          ...
          <div className="hidden lg:flex items-center h-full">
            <Link href="/" className="px-5 py-2 text-blue-900 font-bold hover:text-orange-600 border-b-2 border-transparent hover:border-orange-500 h-full flex items-center transition-all">
              मुख्यपृष्ठ
            </Link>
            ...
            {menuCategories.map((cat, idx) => (
              <div key={idx} className="relative group h-full flex items-center">
                ...
                <div className="absolute top-full left-0 w-[280px] bg-white shadow-2xl border-x border-b border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible translate-y-2 group-hover:translate-y-0 transition-all duration-300 rounded-b-xl overflow-hidden pt-2">
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-full left-0 w-full bg-white border-t shadow-2xl overflow-y-auto max-h-[85vh] animate-in slide-in-from-top duration-300">
          <div className="p-4 space-y-3">
            <Link href="/" className="block p-4 font-bold text-blue-900 bg-blue-50 rounded-xl border border-blue-100">मुख्यपृष्ठ (Home)</Link>
            {menuCategories.map((cat, idx) => (
